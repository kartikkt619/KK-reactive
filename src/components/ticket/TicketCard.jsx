...
import { FaBus, FaStar, FaWifi } from 'react-icons/fa6'
...
const TicketCard = ({icon: Icon, busName, routeFrom, routeTo, arrivalTime, price, avaliableSeats, departureTime }) => {
  return (
    <div className='w-full rounded-xl p-5 border-2 border-neutral-300 space-y-5'>
      ...
      <div className="space-y-5 w-full border-b border-neutral-300/60 pb-4">
       ...
       {/* price, avaliable seats, and reserve button */}     
      <div className="w-full flex items-center justify-between"> 
        {/* price */}
        ...
        <h1 className="text-sm text-neutral-600 font-normal flex items-center justify-center gap-x-1.5">
            <span className="text-lg text-green-700 font-bold pt-0.5">{avaliableSeats}</span> seats avaliable
        </h1>
      
        
        <Link to="/bus-tickets/detail" className="w-fit px-5 py-1.5 bg-red-500 hover:bg-transparent border-2 border-red-500 hover:border-red-500 rounded-xl text-sm font-normal text-neutral-50 flex items-center justify-center gap-x-2 hover:text-red-500 ease-in-out duration-300">      
                Reserve Seat
         </Link>
      </div>
    </div>
